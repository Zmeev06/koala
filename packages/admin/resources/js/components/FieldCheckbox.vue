  ...
  <v-field-base :inline="inline" :label="label" :name="name" :lg="lg" :full="full">
    <div class="grid grid-cols-3 gap-2">
      <div class="flex items-center" v-for="option in form.options[name]">
        <input :id="formName + '-' + name + option.value" type="checkbox" :value="option.value" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" v-model="form.data[name]">
