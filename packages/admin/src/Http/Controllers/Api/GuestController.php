...
use App\Support\Authorization\Http\Controllers\AuthorizeController;

class GuestController extends AuthorizeController
{
    protected $name = 'user';
    ...
    public function index(UserFilters $filters)
    {
      ...
      return User::filter($filters)->whereHas('roles', function (Builder $q) {
        $q->where('id', 7);
      })->with('roles')->simplePaginate();
